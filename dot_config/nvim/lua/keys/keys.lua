...
wk.add({
  ...
  { leader("c"), desc = "CompetiTest", icon = "󰫌" },
  { leader("cr"), cmd(":CompetiTest run"), desc = "Run test case" },
  { leader("ct"), cmd(":CompetiTest add_testcase"), desc = "Add test case" },
  { leader("ce"), cmd(":CompetiTest edit_testcase"), desc = "Edit test case" },
  { leader("cd"), cmd(":CompetiTest delete_testcase"), desc = "Delete test case" },

  -- Float terminal
  { mode = { visual, normal }, "<C-\\>", cmd(":FloatermNew"), desc = "Toggle terminal", icon = "" },
  -- { mode = { visual, normal }, "<C-e>", cmd("<C-\\><C-n>:FloatermKill<CR>"), desc = "Kill terminal", icon = "" },
  ...
  -- Harpoon Navigation
  { leader("a"), function() harpoon:list():add() end, desc = "Harpoon" },
